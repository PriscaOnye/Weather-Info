Problem here with button styling.
<div class="search">
            <input type="search" id="weather-search" name="weather-search" placeholder="Enter city name" spellcheck="false">
            <button type="button" aria-label="search" id="button-search">
